...
import { minVoteHours, MIN_VOTE_HOURS_E2E, SHORT_WINDOWS_ENABLED } from '@/lib/voting/durationLimits';
...
const PRESETS = [
  ...
  ...(SHORT_WINDOWS_ENABLED ? [{ label: '10 min', hours: MIN_VOTE_HOURS_E2E }] : []),
