...
// Event names live in a React-free module so pure code (and its tests) can import the
// vocabulary without pulling in JSX; re-exported here because every existing call site
// imports RefreshEvent from this file.
export { RefreshEvent };
